/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: b82894b97079b4e5d2f514e18c422c3f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<Cloudflare.Env, 'PUBLIC_TURNSTILE_SITE_KEY' | 'TURNSTILE_SECRET_KEY'>
	> {}
}
